<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <body>
    <main class="app" id="appRoot" data-context-path="${pageContext.request.contextPath}">
      ...
      <section class="screen" id="childRewardBoxScreen" data-title="상자 획득" data-subtitle="미션 등급에 맞는 상자를 획득해요">
        <article class="card panel reward-card">
          ...
          <div class="reward-box-visual has-image" id="rewardBoxVisual">
            <img src="${pageContext.request.contextPath}/assets/rewards/reward_box_low_wood.png" alt="보상 상자">
          </div>
