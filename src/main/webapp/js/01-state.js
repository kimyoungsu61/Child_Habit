...
const adminSkipProfileBtn = document.getElementById("adminSkipProfileBtn");
const adminSkipCharacterBtn = document.getElementById("adminSkipCharacterBtn");
const adminProfileSkipBtns = document.querySelectorAll("[data-admin-profile-skip]");
