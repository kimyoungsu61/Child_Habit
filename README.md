...
### 사진/영상 인증과 부모 승인, 펫 성장 보상으로 아이의 행동 습관 형성을 돕는 웹앱 서비스

> 아이는 영상/사진 촬영을 통해 미션을 수행합니다.
> 부모는 아이가 촬연한 영상/사진을 확인해 승인하고, 아이는 보상을 통해 펫을 성장시키며 습관을 이어갑니다.
...
| 항목 | 내용 |
| --- | --- |
| **프로젝트명** | Stable Diffusion 기반 AI 프로필과 펫 성장 시스템을 활용한 보호자 승인식 어린이 습관 형성 서비스 |
...
즉, **실제 행동 수행 → 보호자 확인 → 직관적인 보상 → 성장 경험**의 흐름을 통해 아이가 스스로 행동 습관을 이어가도록 돕는 것이 목표입니다.
...
- **아이 영상 인증**  
  아이는 미션을 수행한 뒤 영상/사진으로 인증 요청을 보냅니다.

- **부모 승인 / 반려**  
  부모는 제출된 영상/사진을 확인하고 승인 또는 반려할 수 있습니다.
...
서비스의 핵심 흐름은 **보호자 미션 등록 → 아이 미션 수행 → 보호자 미션 검증 → 보상 지급** 순서로 진행됩니다.

| ![보호자 미션 등록](docs/화면설계서/화면설계서_보호자미션등록.png) | ![미션 수행](docs/화면설계서/화면설계서_미션수행.png) |
| :---: | :---: |
| **보호자 미션 등록** | **아이 미션 수행** |
| 보호자가 아이에게 수행할 행동 미션을 등록합니다. | 아이가 등록된 미션을 확인하고 수행 인증을 진행합니다. |

| ![보호자 미션 검증](docs/화면설계서/화면설계서_보호자미션검증.png) | ![보상함](docs/화면설계서/화면설계서_보상함.png) |
| :---: | :---: |
| **보호자 미션 검증** | **보상함** |
| 보호자가 아이의 인증 자료를 확인하고 승인 또는 반려합니다. | 승인된 미션에 대한 보상 상자를 확인하고 개봉합니다. |
...
| **한창수** | Frontend | 부모 / 아이 화면 구현, 미션 인증 UI, 보상 및 펫 화면 구현 |
